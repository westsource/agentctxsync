...
```bash
# Choose an agent (hermes | opencode | reasonix | openclaw | workbuddy), default hermes
...
|------|--------|------|
| `HERMES_SYNC_AGENT` | `hermes` | Local storage adapter: `hermes`/`opencode`/`reasonix`/`openclaw`/`workbuddy` |
